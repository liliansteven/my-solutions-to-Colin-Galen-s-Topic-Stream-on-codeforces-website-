...
#define M 32     //the size of the bitset must be a constant number. You can't read n and then declare bitset<n>
...
void LELLO(){
    ...
    ll mn = vc[0] ;
    // instead of iterating over all the possible interval and making the bitwise and of the interval 
    // making bitwise and of all the array by the minimum element of it. it will give me the minimum number 
    for (int i = 1; i < n; i++)
    {
        mn &= vc[i];
    }
